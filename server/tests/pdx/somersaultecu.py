...
from odxtools import write_pdx_file
...
from odxtools.compumethods.compudefaultvalue import CompuDefaultValue
from odxtools.compumethods.compuinternaltophys import CompuInternalToPhys
from odxtools.compumethods.compuinversevalue import CompuInverseValue
...
somersault_assiduous_ecu_admin_data = AdminData(
    language="en-US",
    doc_revisions=[
        DocRevision(
            team_member_ref=OdxLinkRef("TM.Doggy", doc_frags),
            ...
            tool="odxtools 0.1",
            modifications=[
                Modification(change="add new somersault assiduous ECU variant"),
                Modification(change="add variant-specific definitions"),
            ],
        )
    ],
)
...
somersault_units = {
    "second": Unit(
        ...
        factor_si_to_unit=1,
        offset_si_to_unit=0,
        physical_dimension_ref=OdxLinkRef.from_id(somersault_physical_dimensions["time"].odx_id),
    ),
    "minute": Unit(
...
somersault_compumethods: dict[str, CompuMethod] = {
    "int_passthrough": IdenticalCompuMethod(
    ...
    "float_passthrough": IdenticalCompuMethod(
        category=CompuCategory.IDENTICAL,
        internal_type=DataType.A_FLOAT32,
        physical_type=DataType.A_FLOAT32,
    ),
    "boolean": TexttableCompuMethod(
    ...
    "linear": LinearCompuMethod(
            ...
            compu_scales=[
                CompuScale(
                    description=Description.from_string(
                        "<p>Internal to physical linear scale.</p>"
                    ),
                    lower_limit=Limit(value_raw="0", value_type=DataType.A_UINT32),
                    upper_limit=Limit(value_raw="2047", value_type=DataType.A_UINT32),
        ...
        compu_phys_to_internal=CompuPhysToInternal(
            compu_scales=[
                CompuScale(
                    description=Description.from_string("<p>Physical to internal linear scale</p>"),
                    lower_limit=Limit(value_raw="0.5", value_type=DataType.A_FLOAT32),
                    upper_limit=Limit(value_raw="682.8333", value_type=DataType.A_FLOAT32),
                    compu_rational_coeffs=CompuRationalCoeffs(
    ...
    "scale_linear_single": ScaleLinearCompuMethod(
        category=CompuCategory.SCALE_LINEAR,
        internal_type=DataType.A_INT32,
        physical_type=DataType.A_INT32,
        compu_internal_to_phys=CompuInternalToPhys(
            compu_scales=[
                CompuScale(
                    lower_limit=Limit(value_raw="-2047", value_type=DataType.A_INT32),
                    upper_limit=Limit(value_raw="2047", value_type=DataType.A_INT32),
                    compu_rational_coeffs=CompuRationalCoeffs(
    ...
    "scale_linear_multiple": ScaleLinearCompuMethod(
        category=CompuCategory.SCALE_LINEAR,
        internal_type=DataType.A_UINT32,
        physical_type=DataType.A_UINT32,
        compu_internal_to_phys=CompuInternalToPhys(
    ...
    "scale_rat_func": ScaleRatFuncCompuMethod(
    ...
    "texttable_range": TexttableCompuMethod(
        category=CompuCategory.TEXTTABLE,
        internal_type=DataType.A_UINT32,
        physical_type=DataType.A_UNICODE2STRING,
        compu_internal_to_phys=CompuInternalToPhys(
            compu_scales=[
                CompuScale(
                    compu_const=CompuConst(vt="OFF", data_type=DataType.A_UTF8STRING),
                    compu_inverse_value=CompuInverseValue(data_type=DataType.A_UINT32, v="0"),
                    lower_limit=Limit(
                        value_raw="0",
                        value_type=DataType.A_UINT32,
                        interval_type=IntervalType.CLOSED,
                ...
                CompuScale(
                    compu_const=CompuConst(vt="ON", data_type=DataType.A_UTF8STRING),
                    compu_inverse_value=CompuInverseValue(data_type=DataType.A_UINT32, v="5"),
                    lower_limit=Limit(
                        value_raw="5",
                        value_type=DataType.A_UINT32,
                        interval_type=IntervalType.CLOSED,
                ...
                CompuScale(
                    compu_const=CompuConst(vt="OVERLOAD", data_type=DataType.A_UTF8STRING),
                    compu_inverse_value=CompuInverseValue(data_type=DataType.A_UINT32, v="9"),
                    lower_limit=Limit(
                        value_raw="9",
                        value_type=DataType.A_UINT32,
                        interval_type=IntervalType.CLOSED,
            ...
            compu_default_value=CompuDefaultValue(vt="UNDEF", data_type=DataType.A_UTF8STRING),
        ),
    ),
    "prog_code": CompuCodeCompuMethod(
        category=CompuCategory.COMPUCODE,
        internal_type=DataType.A_INT32,
        physical_type=DataType.A_INT32,
        compu_internal_to_phys=CompuInternalToPhys(
            prog_code=ProgCode(
                code_file="compu_code.py",
                syntax="PYTHON3",
                entrypoint="compu_code_i2p",
                revision="1.0",
            )
        ),
        compu_phys_to_internal=CompuPhysToInternal(
            prog_code=ProgCode(
                code_file="compu_code.py",
                syntax="PYTHON3",
                entrypoint="compu_code_p2i",
                revision="1.0",
            )
        ),
    ),
    "tab_intp": TabIntpCompuMethod(
        ...
        compu_internal_to_phys=CompuInternalToPhys(
            compu_scales=[
                CompuScale(
                    ...
                    compu_const=CompuConst(v="0", data_type=DataType.A_UINT32),
                    domain_type=DataType.A_UINT32,
                    range_type=DataType.A_UINT32,
                ),
                CompuScale(
                    ...
                    compu_const=CompuConst(v="5", data_type=DataType.A_UINT32),
                    domain_type=DataType.A_UINT32,
                    range_type=DataType.A_UINT32,
                ),
                CompuScale(
                    ...
                    compu_const=CompuConst(v="8", data_type=DataType.A_UINT32),
                    domain_type=DataType.A_UINT32,
                    range_type=DataType.A_UINT32,
                ),
                CompuScale(
                    ...
                    compu_const=CompuConst(v="10", data_type=DataType.A_UINT32),
                    domain_type=DataType.A_UINT32,
                    range_type=DataType.A_UINT32,
                ),
                CompuScale(
...
somersault_dops = {
    ...
    "soberness_check": DataObjectProperty(
    ...
    "dizzyness_level": DataObjectProperty(
    ...
    "happiness_level": DataObjectProperty(
    ...
    "temperature": DataObjectProperty(
    ...
    "schroedinger_base": DataObjectProperty(
    ...
    "schroedinger_lazy": DataObjectProperty(
    ...
    "schroedinger_assiduous": DataObjectProperty(
    ...
    "uint12_linear": DataObjectProperty(
        odx_id=OdxLinkId("somersault.DOP.uint12_linear", doc_frags),
        short_name="uint12_linear",
        diag_coded_type=somersault_diagcodedtypes["uint12"],
        physical_type=PhysicalType(base_data_type=DataType.A_FLOAT32),
        compu_method=somersault_compumethods["linear"],
    ),
    "int12_scale_linear_single": DataObjectProperty(
        odx_id=OdxLinkId("somersault.DOP.int12_scale_linear_single", doc_frags),
        short_name="int12_scale_linear_single",
        diag_coded_type=somersault_diagcodedtypes["int12"],
        physical_type=PhysicalType(base_data_type=DataType.A_INT32),
        compu_method=somersault_compumethods["scale_linear_single"],
    ),
    "uint8_scale_linear_multiple": DataObjectProperty(
        odx_id=OdxLinkId("somersault.DOP.uint8_scale_linear_multiple", doc_frags),
        short_name="uint8_scale_linear_multiple",
        diag_coded_type=somersault_diagcodedtypes["uint8"],
        physical_type=PhysicalType(base_data_type=DataType.A_UINT32),
        compu_method=somersault_compumethods["scale_linear_multiple"],
    ),
    "int8_rat_func": DataObjectProperty(
        odx_id=OdxLinkId("somersault.DOP.int8_rat_func", doc_frags),
        short_name="int8_rat_func",
        diag_coded_type=somersault_diagcodedtypes["int8"],
        physical_type=PhysicalType(base_data_type=DataType.A_INT32),
        compu_method=somersault_compumethods["rat_func"],
    ),
    "uint8_scale_rat_func": DataObjectProperty(
        odx_id=OdxLinkId("somersault.DOP.uint8_scale_rat_func", doc_frags),
        short_name="uint8_scale_rat_func",
        diag_coded_type=somersault_diagcodedtypes["uint8"],
        physical_type=PhysicalType(base_data_type=DataType.A_UINT32),
        compu_method=somersault_compumethods["scale_rat_func"],
    ),
    "uint8_texttable_range": DataObjectProperty(
        odx_id=OdxLinkId("somersault.DOP.uint8_texttable_range", doc_frags),
        short_name="uint8_texttable_range",
        diag_coded_type=somersault_diagcodedtypes["uint8"],
        physical_type=PhysicalType(base_data_type=DataType.A_UNICODE2STRING),
        compu_method=somersault_compumethods["texttable_range"],
    ),
    "int8_prog_code": DataObjectProperty(
        odx_id=OdxLinkId("somersault.DOP.int8_prog_code", doc_frags),
        short_name="int8_prog_code",
        diag_coded_type=somersault_diagcodedtypes["int8"],
        physical_type=PhysicalType(base_data_type=DataType.A_INT32),
        compu_method=somersault_compumethods["prog_code"],
    ),
    "int8_tab_intp": DataObjectProperty(
        odx_id=OdxLinkId("somersault.DOP.int8_tab_intp", doc_frags),
        short_name="int8_tab_intp",
        diag_coded_type=somersault_diagcodedtypes["int8"],
        physical_type=PhysicalType(base_data_type=DataType.A_INT32),
        compu_method=somersault_compumethods["tab_intp"],
    ),
}

somersault_dtcs = {
    "dtc_1001": DiagnosticTroubleCode(
        odx_id=OdxLinkId("somersault.DTC.dtc_1001", doc_frags),
        short_name="DTC_1001",
        display_trouble_code="P1001",
        trouble_code=4097,
        text=Text(text="Motor malfunction."),
        level=2,
    ),
    "dtc_1002": DiagnosticTroubleCode(
        odx_id=OdxLinkId("somersault.DTC.dtc_1002", doc_frags),
        short_name="DTC_1002",
        display_trouble_code="B1002",
        trouble_code=4098,
        text=Text(text="Energy level dropped below minimum."),
        level=7,
    ),
}
...
somersault_dtc_dops = {
    "dtc_dop_all": DtcDop(
        short_name="dtc_dop_all",
        odx_id=OdxLinkId("somersault.DTC_DOP.dtc_dop_all", doc_frags),
        diag_coded_type=somersault_diagcodedtypes["uint16"],
        physical_type=PhysicalType(base_data_type=DataType.A_UINT32),
        ...
        dtcs_raw=list(somersault_dtcs.values()),
    ),
}
...
somersault_positive_responses = {
        ...
        parameters=NamedItemList(
            [
                CodedConstParameter(
                    ...
                    byte_position=0,
                    coded_value_raw=str(
                        uds.positive_response_id(SID.DiagnosticSessionControl.value)  # type: ignore[attr-defined]
                    ),
                ),
                ValueParameter(
        ...
        parameters=NamedItemList(
            [
                CodedConstParameter(
                    ...
                    diag_coded_type=somersault_diagcodedtypes["uint8"],
                    byte_position=0,
                    coded_value_raw=str(uds.positive_response_id(SID.TesterPresent.value)),  # type: ignore[attr-defined]
                ),
                ValueParameter(
                    short_name="status",
                    semantic="DATA",
    ...
    "forward_flips_grudgingly_done": Response(
        ...
        parameters=NamedItemList(
            [
                CodedConstParameter(
                    ...
                    diag_coded_type=somersault_diagcodedtypes["uint8"],
                    byte_position=0,
                    coded_value_raw=str(uds.positive_response_id(SID.ForwardFlip.value)),  # type: ignore[attr-defined]
                ),
    ...
    "forward_flips_happily_done": Response(
    ...
    "backward_flips_grudgingly_done": Response(
        ...
        parameters=NamedItemList(
            [
                CodedConstParameter(
                    ...
                    diag_coded_type=somersault_diagcodedtypes["uint8"],
                    byte_position=0,
                    coded_value_raw=str(uds.positive_response_id(SID.BackwardFlip.value)),  # type: ignore[attr-defined]
                ),
                ValueParameter(
                    short_name="num_flips_done",
                    semantic="DATA",
        ...
        parameters=NamedItemList(
            [
                CodedConstParameter(
                    ...
                    diag_coded_type=somersault_diagcodedtypes["uint8"],
                    byte_position=0,
                    coded_value_raw=str(uds.positive_response_id(SID.ReadDataByIdentifier.value)),  # type: ignore[attr-defined]
                ),
                ValueParameter(
                    short_name="dizzyness_level",
                    semantic="DATA",
        ...
        parameters=NamedItemList(
            [
                CodedConstParameter(
                    ...
                    diag_coded_type=somersault_diagcodedtypes["uint8"],
                    byte_position=0,
                    coded_value_raw=str(uds.positive_response_id(SID.ForwardFlipCondition.value)),  # type: ignore[attr-defined]
                ),
            ]
        ),
    ),
...
somersault_structures = {
    "forward_flips_grudgingly_done": Structure(
    ...
    "forward_flips_happily_done": Structure(
    ...
    "backward_flips_grudgingly_done": Structure(
...
somersault_tables = {
    "last_flip_details": Table(
        ...
        table_rows_raw=[
            ...
            TableRow(
                table_ref=last_flip_details_table_ref,
                odx_id=OdxLinkId("somersault.table.last_flip_details.forward_grudging", doc_frags),
        ...
        parameters=NamedItemList(
            [
                CodedConstParameter(
                    ...
                    diag_coded_type=somersault_diagcodedtypes["uint8"],
                    byte_position=0,
                    coded_value_raw=str(SID.DiagnosticSessionControl.value),  # type: ignore[attr-defined]
                ),
                CodedConstParameter(
                    short_name="id",
                    semantic="ID",
    ...
    "stop_session": Request(
        ...
        parameters=[
            CodedConstParameter(
                ...
                byte_position=0,
                coded_value_raw=str(
                    SID.DiagnosticSessionControl.value  # type: ignore[attr-defined,arg-type]
                ),
            ),
            CodedConstParameter(
                short_name="id",
    ...
    "tester_present": Request(
        ...
        parameters=[
            CodedConstParameter(
                ...
                diag_coded_type=somersault_diagcodedtypes["uint8"],
                byte_position=0,
                coded_value_raw=str(SID.TesterPresent.value),  # type: ignore[attr-defined,arg-type]
            ),
            CodedConstParameter(
                short_name="id",
                semantic="ID",
    ...
    "set_operation_params": Request(
        ...
        parameters=[
            CodedConstParameter(
                ...
                byte_position=0,
                coded_value_raw=str(
                    SID.ForwardFlipCondition.value  # type: ignore[attr-defined,arg-type]
                ),
            ),
            ValueParameter(
    ...
    "forward_flips": Request(
        ...
        parameters=[
            CodedConstParameter(
                ...
                diag_coded_type=somersault_diagcodedtypes["uint8"],
                byte_position=0,
                coded_value_raw=str(SID.ForwardFlip.value),  # type: ignore[attr-defined,arg-type]
            ),
            ValueParameter(
    ...
    "backward_flips": Request(
        ...
        parameters=[
            CodedConstParameter(
                ...
                diag_coded_type=somersault_diagcodedtypes["uint8"],
                byte_position=0,
                coded_value_raw=str(SID.BackwardFlip.value),  # type: ignore[attr-defined,arg-type]
            ),
            ValueParameter(
    ...
    "report_status": Request(
        ...
        parameters=[
            CodedConstParameter(
                ...
                byte_position=0,
                coded_value_raw=str(
                    SID.ReadDataByIdentifier.value  # type: ignore[attr-defined,arg-type]
                ),
            ),
            CodedConstParameter(
                short_name="id",
...
somersault_services = {
    ...
    "stop_session": DiagService(
        ...
        functional_class_refs=[OdxLinkRef.from_id(somersault_functional_classes["session"].odx_id)],
    ),
    "tester_present": DiagService(
    ...
    "set_operation_params": DiagService(
    ...
    "forward_flips": DiagService(
        ...
        functional_class_refs=[OdxLinkRef.from_id(somersault_functional_classes["flip"].odx_id)],
    ),
    "backward_flips": DiagService(
...
somersault_single_ecu_jobs = {
    "compulsory_program": SingleEcuJob(
...
somersault_base_diag_data_dictionary_spec = DiagDataDictionarySpec(
    ...
    dtc_dops=NamedItemList(somersault_dtc_dops.values()),
)
...
somersault_protocol_raw = ProtocolRaw(
    ...
    comparam_spec_ref=OdxLinkRef(
        "CPS_ISO_15765_3_on_ISO_15765_2",
...
somersault_assiduous_ecu_raw = EcuVariantRaw(
    ...
    admin_data=somersault_assiduous_ecu_admin_data,
...
for odx_cs_filename in (
    ...
    if subset is not None:
        ...
        context = OdxDocContext(
            ODX_VERSION, (OdxDocFragment(category_sn, DocType.COMPARAM_SUBSET),)
        )
...
database.add_auxiliary_file(
    "compu_code.py",
    BytesIO(b"""
def compu_code_i2p(internal: int) -> int:
  if (internal > 100):
      return internal * 2 - 5
  else:
      return internal
            
def compu_code_p2i(physical: int) -> int:
  if (physical > 100):
      return round((physical - 5) / 2)
  else:
      return physical
"""),
)
...
# Generate a PDX archive from the database in the current folder
write_pdx_file("./tests/somersault.pdx", database)
